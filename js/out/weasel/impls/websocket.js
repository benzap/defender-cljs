...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj30452 = {};return obj30452;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__12574__auto__ = this$;if(and__12574__auto__)
...
{var x__13223__auto__ = (((this$ == null))?null:this$);return (function (){var or__12586__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__13223__auto__)]);if(or__12586__auto__)
{return or__12586__auto__;
} else
{var or__12586__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__12586__auto____$1)
...
return (function (p__30453){var vec__30454 = p__30453;var k = cljs.core.nth.call(null,vec__30454,(0),null);var v = cljs.core.nth.call(null,vec__30454,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
