...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__13163__auto__,writer__13164__auto__,opt__13165__auto__){return cljs.core._write.call(null,writer__13164__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_33544 = (0);while(true){
if((i_33544 < arr.length))
{(arr[i_33544] = null);
{
var G__33545 = (i_33544 + (1));
i_33544 = G__33545;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__13163__auto__,writer__13164__auto__,opt__13165__auto__){return cljs.core._write.call(null,writer__13164__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_33551 = (self__.level + (1));while(true){
if((i_33551 <= (new_level + (1))))
{(update[i_33551] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_33553 = (0);while(true){
if((i_33553 <= self__.level))
{var links_33554 = (update[i_33553]).forward;if(((links_33554[i_33553]) === x__$1))
{(links_33554[i_33553] = (x__$1.forward[i_33553]));
{
var G__33555 = (i_33553 + (1));
i_33553 = G__33555;
continue;
}
} else
{{
var G__33556 = (i_33553 + (1));
i_33553 = G__33556;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__12586__auto__ = (cljs.core.truth_((function (){var and__12574__auto__ = me;if(cljs.core.truth_(and__12574__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__12574__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__12586__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__12586__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__12586__auto__,timeout__$1,me))
,msecs);
