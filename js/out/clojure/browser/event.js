...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj30315 = {};return obj30315;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__12574__auto__ = this$;if(and__12574__auto__)
...
{var x__13223__auto__ = (((this$ == null))?null:this$);return (function (){var or__12586__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__13223__auto__)]);if(or__12586__auto__)
{return or__12586__auto__;
} else
{var or__12586__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__12586__auto____$1)
...
return (function (p__30316){var vec__30317 = p__30316;var k = cljs.core.nth.call(null,vec__30317,(0),null);var v = cljs.core.nth.call(null,vec__30317,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__30318){var vec__30319 = p__30318;var k = cljs.core.nth.call(null,vec__30319,(0),null);var v = cljs.core.nth.call(null,vec__30319,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
